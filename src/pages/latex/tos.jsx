const TOS = () => (
  <>
    <div className="main">
      ...
      <p>Nicholas G, the operator of the Microsoft Teams 'LaTeX Formatter' bot (hereon referred to as 'the bot'), mandates that, in utilising such bot, you agree to the following terms of service: </p>
      ...
      <p>If you find any bugs or security vulnerabilities in the software, you agree to inform the developers at <a href="mailto:security@nicholasg.me">security@nicholasg.me</a> within a reasonable amount of time.</p>
    </div>
    <style jsx>{`
    :global(html, body) {
      padding: 0;
