...
const About = () => (
  <div>
    ...
    <ul className="socials">
      <li><a target="_blank" rel="noopener noreferrer" href="https://linkedin.com/in/nicholas-g" aria-label="LinkedIn"><SiLinkedin /></a></li>
      <li><a target="_blank" rel="noopener noreferrer" href="https://twitter.com/WagwanNick" aria-label="Twitter"><SiTwitter /></a></li>
      <li><a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/users/6710619/nicholasg04" aria-label="StackOverflow"><SiStackoverflow /></a></li>
      <li><a target="_blank" rel="noopener noreferrer" href="https://github.com/NicholasG04" aria-label="GitHub"><SiGithub /></a></li>
    </ul>
